    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-600">Cargando promociones...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Promociones y Popups</h2>
              ...
              <div className="mt-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 text-slate-600 hover:text-[#1c6554] hover:bg-slate-100 transition-colors rounded"
                    title="Editar"
                  >
                    <EditIcon />
                  </button>
                  <button
                    ...
                    className="p-2 text-slate-600 hover:text-red-600 hover:bg-red-50 transition-colors rounded"
                    title="Eliminar"
                  >
                    <TrashIcon />
                  </button>
      ...
      {promotions.length === 0 && (
        <div className="text-center py-12 bg-slate-50 border border-slate-200">
          ...
          <p className="text-slate-600 mb-4">No hay promociones creadas</p>
          <button
            onClick={handleAddPromotion}
            className="px-4 py-2 bg-[#1c6554] hover:bg-[#1c6554]/90 text-white font-medium transition-colors"
          >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="px-4 py-2 bg-[#1c6554] hover:bg-[#1c6554]/90 text-white text-sm font-medium transition-colors disabled:opacity-50"
            >
