 ...
 * 
 * Renderiza un icono SVG profesional según el nombre de la categoría.
 * Si no hay coincidencia, muestra un icono genérico de "caja".
 * 
 * @param {CategoryIconProps} props
 * @returns {JSX.Element}
 * 
 * @example
 * // Icono de categoría de frutas
 * <CategoryIcon name="Frutas y Verduras" className="w-16 h-16" />
 * 
 * // Icono por defecto si no hay coincidencia
 * <CategoryIcon name="Otra categoría" />
 */
